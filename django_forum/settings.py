...
SECRET_KEY = 'django-insecure-gvx@wv%@v75mb^4y8iyx(7i-_7sz#!!f+=)q8p8^_^i!si4n3a'
...
cloudinary.config(
    ...
    cloud_name="di4rm0lnl",
    api_key="245518884163565",
    api_secret="lWjKE_k68-q3EfCXN5G1KvZvnas",
    secure = True,
)
